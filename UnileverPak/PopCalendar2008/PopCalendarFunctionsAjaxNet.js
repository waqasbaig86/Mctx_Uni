...
function __PopCalValidateOnSubmit(val,args)
{
	...
	if(!__PopCalFormatControl(o))
	{
		...
		if((_invalidDate=="")||(_invalidDate==null)) 
		    {
		    _invalidDate="Invalid Date"
		    }
		o.value = ""; //modified by 2258
...
function __PopCalSelectDate(_o)
{
	...
	if(o.value!=o.oldValue)
	{
		...
		//ONCHANGE EVENT OF RJS POP CALENDAR - 2258
		if(_o=='ctl00_MTBCDynamicWebContentsPlaceHolder_txtDateAddApp')
		    {
		    try
		        {
		        reProcessTimeOpt();
