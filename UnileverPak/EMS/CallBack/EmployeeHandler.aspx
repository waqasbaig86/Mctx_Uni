    ...
    #StartEmployee#
            <asp:Repeater ID="rptEmployee" runat="server">
                <ItemTemplate>
                    <tr>
                        <td>                           
                        <span class="edit-icon" onclick="editEmployees('<%# Eval("id") %>',this)"></span>                           
                        </td>
                        <td>
                            <div class="icons">
                        <span style="margin:0 auto" class="health-icon" onclick="addMedicalDetail('<%# Eval("id") %>',this)"></span>                            
                                </div>
                        </td>
                        ...
                        <td class="phto">
                            <img src='<%# "../EMS/CallBack/GetImageDatafromDB.aspx?PrimaryKeyIDValue=" + System.Convert.ToString(Eval("id") + "&tableName=tbl_employee&ImagecolumnName=photo&PrimaryKeyColumnName=employee_id&date="+DateTime.Now+"") %>' style="height: 50px; width: 50px" /></td>
                        ...
                        <td style="white-space: nowrap; display: none">
                            ...
                            <span class="Employer_Id"><%# Eval("Employer_Id") %></span>
                                <span class="Emp_Category"><%# Eval("Emp_Category") %></span>
                       ...
                       <asp:Image ID="Image" runat="server" Width="50px" Height="50px" ImageUrl='<%#"../RMS/VisitorPictures/"+Eval("photo")+".jpg" %>'/>
                        ...
                        <td><span onclick="ShowDetails_Modal('<%# Eval("id") %>',this,'1')">
                            <img style="padding-left: 10%;" src='../images/Details.png' /></span> </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
    #EndEmployee#
